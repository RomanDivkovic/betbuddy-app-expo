...
export default function GroupDetailsScreen() {
  ...
  const loadGroupData = async () => {
    try {
      ...
      setGroup(groupData);
      setPosts(groupPosts.sort((a, b) => 
        new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
      ));
      setEvents(groupEvents.sort((a, b) => 
    ...
    >
      <View style={styles.eventHeader}>
        ...
        <View style={styles.eventStatus}>
          <Text style={[
            styles.statusText,
            { color: event.status === 'upcoming' ? '#2563eb' : 
                     event.status === 'live' ? '#dc2626' : '#16a34a' }
          ]}>
        ...
        return (
          <View style={styles.tabContent}>
            ...
            >
              ...
              <Text style={styles.createPostText}>Share something with the group</Text>
            </TouchableOpacity>
